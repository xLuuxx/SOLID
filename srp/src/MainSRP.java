...
public class MainSRP {
    ...
    public static void main(String[] args) {
        ...
        DocumentPrint afficheur = new DocumentPrint();
        DocumentSave sauvegarde = new DocumentSave();

        FacturationService service = new FacturationService(afficheur, sauvegarde);
